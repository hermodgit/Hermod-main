    ...
    <div style={{ minHeight: '100dvh', background: 'hsl(0 0% 3%)', fontFamily: 'Inter, system-ui, sans-serif', overflowX: 'hidden' }}>
      ...
      <section className="home-section home-hero" style={{ position: 'relative', zIndex: 1, padding: '96px 40px 80px', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: 16, display: 'flex', justifyContent: 'center' }}>
          <div style={{
            display: 'inline-flex', alignItems: 'center', gap: 8,
            padding: '6px 14px', background: 'hsl(0 0% 4%)',
            border: '1px solid hsl(0 0% 10%)', borderRadius: 2,
          }}>
            <span style={{ fontSize: 9, color: 'hsl(0 0% 30%)', letterSpacing: '0.1em', textTransform: 'uppercase', fontFamily: 'JetBrains Mono, monospace' }}>Contract</span>
            <span style={{ width: 1, height: 10, background: 'hsl(0 0% 12%)' }} />
            <a
              href="https://etherscan.io/address/0x1caf0522fe19f1665b30736884f822b0ede8bd33"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                fontFamily: 'JetBrains Mono, monospace', fontSize: 10,
                color: 'hsl(0 0% 45%)', textDecoration: 'none',
            ...
            >
              0x1caf0522fe19f1665b30736884f822b0ede8bd33
            </a>
            <button
              onClick={() => navigator.clipboard.writeText('0x1caf0522fe19f1665b30736884f822b0ede8bd33')}
              style={{
                background: 'none', border: 'none', cursor: 'pointer',
                color: 'hsl(0 0% 28%)', padding: 0, display: 'inline-flex',
                transition: 'color 150ms',
              }}
              onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.color = 'hsl(0 0% 60%)'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.color = 'hsl(0 0% 28%)'; }}
              title="Copy address"
            >
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <a
            href="https://github.com/hermodgit/Hermod-main"
            target="_blank"
            rel="noopener noreferrer"
            title="Hermod on GitHub"
            style={{
              display: 'inline-flex', alignItems: 'center', gap: 6,
              fontSize: 10, color: 'hsl(0 0% 35%)', textDecoration: 'none',
              padding: '4px 10px',
